...
routerDB.get("/premium/controlpanel");
routerDB.post("/premium/controlpanel");
routerDB.post("/premium/controlpanel/update/:id");
routerDB.delete("/premium/controlpanel/delete/:id");
